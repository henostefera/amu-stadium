...
const BuyTicket = () => {
  ...
  const handleNameChange = (value: string) => {
    setReceiverName(toTitleCase(value));
  };

  const validatePhone = (phone: string) => {
    // Remove +251 prefix and spaces for validation
  ...
  const handleContactChange = (value: string) => {
    if (sendMethod === "phone") {
      // Keep only digits and limit to 9 digits
  ...
  const isGiftFormValid = () => {
    ...
    if (!receiverContact) return false;
    
    if (sendMethod === "phone") {
      return validatePhone(receiverContact);
    } else {
      return validateEmail(receiverContact);
    }
  };
  ...
  const handlePurchase = () => {
    ...
    if (isGiftMode && receiverName && receiverContact) {
      ...
      // Reset gift fields after 3 seconds
      setTimeout(() => {
            ...
            <Card className="shadow-stadium animate-fade-in">
              ...
              <CardContent className="space-y-6">
                ...
                <div>
                  ...
                  <div className="flex gap-3">
                    <Button
                      ...
                      className={!isGiftMode ? "gradient-hero" : ""}
                    >
                    ...
                    <div>
                      ...
                      <div className="flex gap-3 mb-3">
                        <Button
                          ...
                          className={sendMethod === "phone" ? "gradient-hero flex-1" : "flex-1"}
                        >
                        ...
                        <Button
                          ...
                          className={sendMethod === "email" ? "gradient-hero flex-1" : "flex-1"}
                        >
                ...
                <div>
                  ...
                  <div className="flex gap-3">
                    <Button
                      ...
                      className={currency === "ETB" ? "gradient-hero" : ""}
                    >
                      ETB (Birr)
                    </Button>
                    <Button
                      ...
                      className={currency === "USD" ? "gradient-hero" : ""}
                    >
                      USD (Dollar)
                    </Button>
                  </div>
                ...
                <Button
                  ...
                  size="lg"
                  className="w-full gradient-hero text-primary-foreground hover:opacity-90 transition-stadium text-lg h-14"
                ...
                <div className="text-center">
                  ...
                  <div className="flex justify-center gap-4 opacity-50">
                    <div className="px-4 py-2 border rounded-md text-xs font-semibold">
                      TELEBIRR
                    </div>
                    <div className="px-4 py-2 border rounded-md text-xs font-semibold">
                      CBE BIRR
