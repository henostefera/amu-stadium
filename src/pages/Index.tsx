...
const Index = () => {
  ...
  <span className="text-white">100 ETB</span>
                ...
                <p className="text-lg mb-6 text-muted-foreground max-w-xl mx-auto">
                  Every ticket purchased directly supports the construction of Arbaminch Stadium 
                  and gives you a chance to win amazing prizes!
                </p>
          ...
          <div className="container px-4">
            <div className="text-center mb-12 animate-fade-in">
              ...
              <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                Every ticket purchased helps build a world-class stadium for Ethiopia
              </p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              <div className="text-center animate-slide-in">
                <div className="mx-auto mb-4 p-4 rounded-full bg-stadium-blue/10 w-fit">
                  <Building className="w-8 h-8 text-stadium-blue" />
                </div>
                <h3 className="text-xl font-bold font-poppins mb-2">World-Class Infrastructure</h3>
                <p className="text-muted-foreground">
                  Building a modern 60,000-seat stadium with international standards
                </p>
              </div>
              ...
              <div className="text-center animate-slide-in" style={{ animationDelay: "100ms" }}>
                ...
                <h3 className="text-xl font-bold font-poppins mb-2">Community Development</h3>
                <p className="text-muted-foreground">
                  Creating jobs and opportunities for local communities
                </p>
              </div>
              ...
              <div className="text-center animate-slide-in" style={{ animationDelay: "200ms" }}>
                ...
                <h3 className="text-xl font-bold font-poppins mb-2">National Pride</h3>
                <p className="text-muted-foreground">
                  Elevating Ethiopia's status as a sports destination in Africa
                </p>
              </div>
            </div>
          </div>
